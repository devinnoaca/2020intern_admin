...
SELECT un.ID id, n.type type, receiver.ID receiver_ID, sender.ID sender_ID, un.is_checked is_checked, un.time time \
...
export default {
  ...
  searchUserNotification, deleteUserNotification
};